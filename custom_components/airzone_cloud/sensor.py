...
from .const import (
    SENSOR_COMPRESSOR_DISCHARGE_PRESSURE,
    SENSOR_COMPRESSOR_DISCHARGE_TEMPERATURE,
...
from homeassistant.const import (
    ...
    EntityCategory,
    UnitOfTemperature, UnitOfElectricCurrent, UnitOfPressure,
)
...
AIDOO_SENSOR_TYPES: Final[tuple[SensorEntityDescription, ...]] = (
    SensorEntityDescription(
        ...
        key=AZD_CONSUMPTION_UE,
        name=SENSOR_POWER_CONSUMPTION,
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
        device_class=SensorDeviceClass.TEMPERATURE,
        key=AZD_DISCH_COMP_TEMP_UE,
        name=SENSOR_COMPRESSOR_DISCHARGE_TEMPERATURE,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
        device_class=SensorDeviceClass.TEMPERATURE,
        key=AZD_EXCH_HEAT_TEMP_IU,
        name=SENSOR_INDOOR_UNIT_HEAT_EXCHANGER_TEMPERATURE,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
        device_class=SensorDeviceClass.TEMPERATURE,
        key=AZD_EXCH_HEAT_TEMP_UE,
        name=SENSOR_OUTDOOR_UNIT_HEAT_EXCHANGER_TEMPERATURE,
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        state_class=SensorStateClass.MEASUREMENT,
    ),
    SensorEntityDescription(
    ...
    SensorEntityDescription(
        ...
        key=AZD_PE_UE,
        name=SENSOR_COMPRESSOR_DISCHARGE_PRESSURE,
